...
ModType1::ModType1(const int cn,const G4ThreeVector& pos,
...
void ModType1 :: DefineBorderProperties(){
  const G4int NUMENTRIES = 2;
  G4double ephoton[NUMENTRIES] = {2.00*eV,4.80*eV};
...
void ModType1::ConstructDetector()
{
  // Get Config
  TEnv* config = m_sd->GetConfig();
  ...
  //  m_WLatCenter                   = new G4Box ("W_Lat_Center", 0.899999*cm/2.0 ,     18.0*cm/2.0  , 1.0*cm/2.0);
    m_WLatCenter                   = new G4Box ("W_Lat_Center", 0.9*cm/2.0 ,     18.0*cm/2.0  , 1.0*cm/2.0);
    //  m_WLatEdge                     = new G4Box ("W_Lat_Edge", (0.749999)*cm/2.0 ,    18.0*cm/2.0  , 1.0*cm/2.0);
    m_WLatEdge                     = new G4Box ("W_Lat_Edge", (0.75)*cm/2.0 ,    18.0*cm/2.0  , 1.0*cm/2.0);
    double w_long_x = 0.144625/2.0;
  m_WLong                         = new G4Box ("W_Long", w_long_x*cm, 18.0*cm/2.0  , 13.4*cm/2.0);
  m_AirGap                        = new G4Box ("Air_Gap", w_long_x*cm ,18.0*cm/2.0  , 0.2*cm/2.0);
  ...
  G4VisAttributes* absorberColor2 = new G4VisAttributes( G4Colour::Yellow() );
  //absorberColor2->SetForceSolid(true);

  
  m_WLatCenterLogical->SetVisAttributes( absorberColor2 );
  m_WLatEdgeLogical->SetVisAttributes( absorberColor2 );
  ...
  m_PixelAirWLogical->SetVisAttributes( quartzColor );
  m_PixelAirRadLogical->SetVisAttributes( quartzColor );
  ...
  */
  std::cout << "ModType1 construction finished: SD name " << quartzSDname << std::endl;
