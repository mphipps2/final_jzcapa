...
class RunMessenger: public G4UImessenger{
  ...
  private:
    ...
    G4UIdirectory*             fTreeDir;

    G4UIcmdWithAString*        fOutputFileNameCmd;
    G4UIcmdWithABool*          fClusterTreesCmd;
    G4UIcmdWithABool*          fOpticalTreesCmd;
    G4UIcmdWithAnInteger*      fSetnZDCTreesCmd;
    G4UIcmdWithAnInteger*      fSetnRPDTreesCmd;
