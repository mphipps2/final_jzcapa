...
public:
  ...
  ~RpdHit();
  RpdHit(const RpdHit&);
  const RpdHit& operator=(const RpdHit&);
  G4int operator==(const RpdHit&) const;
...
typedef G4THitsCollection<RpdHit> RpdHitsCollection;

extern G4Allocator<RpdHit> RpdHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline void* RpdHit::operator new(size_t)
{
  void *aHit;
  aHit = (void *) RpdHitAllocator.MallocSingle();
  return aHit;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline void RpdHit::operator delete(void *aHit)
{
  RpdHitAllocator.FreeSingle((RpdHit*) aHit);
}
